        ...
        reserveSlot: async function(json){
            ...
            */
            ...
            if(pass.active) {
                ...
                fetch('https://ticket.expo2025.or.jp/event_search/?id='+localStorage.ticket_id+'&keyword=&screen_id=108&lottery='+(isToday(localStorage.date)? '5' : '4')+'&entrance_date='+localStorage.date);
